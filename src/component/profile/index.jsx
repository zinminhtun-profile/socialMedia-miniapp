          ...
          <div className="col m6  offset-s1 offset-m1">
            ...
            <div className="row">
              ...
              <div className="col m12 pff">
                <div className="pword"><b>{convert(post_count)}</b> post</div>
                <div className="pword"><b>{convert(follow_count)}</b> follower</div>
                <div className="pword"><b>{convert(following_count)}</b> following</div>
              </div>
